...
import { Search, Package, Clock, CheckCircle, XCircle, Truck, User, Mail, Phone } from 'lucide-react';
                    ...
                    <div className="text-center py-12 bg-white rounded-2xl shadow-lg border border-gray-200">
                        {orders.length === 0 ? (
                            <div className="space-y-4">
                                ...
                                <h3 className="text-xl font-semibold text-gray-700">No orders found in system</h3>
                                    ...
                                    <div className='flex justify-between items-start'>
                                        <div className='space-y-4 flex-1'>
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-sm text-gray-600">
                                                ...
                                                <div>
                                                    <strong>Total:</strong> LKR {order.totalAmount?.toFixed(2)}
                                                </div>
                                            </div>
                                        ...
                                        <div className='flex flex-col gap-3 ml-4'>
                                            ...
                                            {!['Completed', 'Cancelled'].includes(order.status) && (
                                                <select 
                                                    className='select select-sm border-2 border-gray-300 bg-gray-50 rounded-lg focus:border-blue-500 text-gray-800'
                                                    value={order.status}
