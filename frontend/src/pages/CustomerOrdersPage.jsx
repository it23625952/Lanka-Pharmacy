...
import { Search, Package, Clock, CheckCircle, XCircle, Truck, Filter, FileText, Phone, Mail } from 'lucide-react';
        ...
        <div className='min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-50 flex flex-col'>
            ...
            <div className='flex-1 container mx-auto px-4 py-8 max-w-6xl relative z-10'>
                ...
                <div className='text-center mb-12'>
                    ...
                    <p className='text-gray-600 text-xl'>Track and manage your medication orders</p>
                </div>
                            ...
                            <div key={order._id} className='bg-white rounded-3xl shadow-2xl border border-gray-100 hover:shadow-2xl transition-all duration-300 overflow-hidden'>
                                ...
                                <div className='p-8'>
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                        {/* Order Summary */}
                                        <div className="space-y-6">
                                            <h4 className="text-lg font-semibold text-gray-800 border-b border-gray-200 pb-2">Order Summary</h4>
                                            <div className="grid grid-cols-2 gap-4">
                                                <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
                                                    <p className="text-gray-600 text-sm">Total Amount</p>
                                                    <p className="text-2xl font-bold text-emerald-600">LKR {order.totalAmount?.toFixed(2)}</p>
                                                </div>
                                                <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
                                                    <p className="text-gray-600 text-sm">Items</p>
                                                    <p className="text-2xl font-bold text-emerald-600">{calculateTotalItems(order)}</p>
                                                </div>
                                            </div>
                                            <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
                                                <p className="text-gray-600 text-sm">Order Date</p>
                                                <p className="font-semibold text-gray-800">{new Date(order.createdAt).toLocaleDateString('en-US', { 
                                                    weekday: 'long', 
                                                    year: 'numeric', 
                                                    month: 'long', 
                                                    day: 'numeric' 
                                        ...
                                        {/* Order Timeline */}
                                        <div className="space-y-6">
                                            <h4 className="text-lg font-semibold text-gray-800 border-b border-gray-200 pb-2">Order Status</h4>
                                            <div className="space-y-4">
                                                ...
                                                {!order.pickedUpAt && order.status === 'Ready for Pickup' && (
                                                    <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
                                                        <p className="text-blue-800 font-semibold">
                                                            🎉 Your order is ready for pickup!
                                                        </p>
                                                        <p className="text-blue-600 text-sm mt-1">
                                                            Visit our pharmacy to collect your medication
                                                        </p>
                                                    </div>
                                                )}
                                            </div>
                                    ...
                                    {order.notes && (
                                        <div className='bg-gray-50 rounded-xl p-4 mt-6 border border-gray-200'>
                                            <strong className="text-gray-700 block mb-2">📝 Pharmacy Notes:</strong>
                ...
                <div className="text-center mt-12 pt-8 border-t border-gray-200">
                    <div className="bg-white rounded-3xl shadow-lg p-6 border border-gray-100 max-w-2xl mx-auto">
                        <h4 className="text-lg font-semibold text-gray-800 mb-2">Need Help With Your Order?</h4>
                        <p className="text-gray-600 mb-4">
                            Contact our pharmacy team for any questions about your orders
                        </p>
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <a href="tel:+94512225523" className="inline-flex items-center gap-2 px-6 py-3 bg-emerald-600 text-white rounded-xl hover:bg-emerald-700 transition-all duration-200 font-medium">
                                <Phone className="size-4" />
                                Call +94 51 222 5523
                            </a>
                            <a href="mailto:lp.hatton.sup@gmail.com" className="inline-flex items-center gap-2 px-6 py-3 border-2 border-emerald-600 text-emerald-600 rounded-xl hover:bg-emerald-50 transition-all duration-200 font-medium">
